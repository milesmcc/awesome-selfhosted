...
- [Shynet](https://github.com/milesmcc/shynet) - modern, privacy-friendly, and detailed web analytics that works without cookies or JS. ([Source Code](https://github.com/milesmcc/shynet)) `Apache-2.0` `Python`
